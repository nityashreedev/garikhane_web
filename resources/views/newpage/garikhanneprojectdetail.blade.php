...
<div class="banner" style="position: relative;
    ...
    <div class="shadow-main">
        <h1> {{$garikhanneproject->title}} </h1>
        <ul class="breadcrumb breadcrumb-news">
            <li><a href="{{url('/')}}">HOME</a></li>
            <li><a href="{{url('garkhanne/project')}}">GARIKHANNE PROJECT</a></li>
            <li><a>{{$garikhanneproject->title}}</a></li>
                    ...
                    <div class="post-single">
                        <div class="person-card post-single-cont">
                            <div class="person-content">
                                ...
                                <p>{!! substr($garikhanneproject->description,0,20000) !!}</p>


                               <h3>Project Details</h3>
                                 <p style="text-align:justify">{!! substr($garikhanneproject->details,0,20000) !!}</p> 
