            ...
            <div class="col-md-8 col-sm-6 col-xs-12">
                <div class="leave-reply">
                    <form method="POST" action="{{url('contact/form')}}" accept-charset="UTF-8" class="contact-form"
                        id="contactForms" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <input id='phone' name="address" type="text" placeholder="Address" class="form-control">
                        </div>
                        <div class="form-group">
                            <textarea id="enquiry" class="form-control" rows="6" name="enquiry"
...
<div class="map">
    <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1oMb-_Sintp39ZDkDuAcNxa1vcLCiur0_" width="640"
        height="480"></iframe>

</div>
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDqoUGdzvIo-cF3hxRdTG3T9RwKem0G2GMcallback=initMap&libraries=&v=beta"
    async></script>
