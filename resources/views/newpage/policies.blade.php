        ...
        <div class="container">
            <div class="row">
                ...
                <div class="text-policy">
                    ...
                    <ol>
                        <li class="policy-list">Account means a unique account created for You to access our Service or parts of our Service</li>
                        <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to कर्मभूमि समाज, Hattiwan, Lalitpur-15, Bagmati Province, Nepal.</li>
                        ...
                        <li>Website refers to कर्मभूमि समाज, accessible from https://www.karmabhoomisamaj.com</li>
                        <li>You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                    
                    </ol>
                </div>
                <h3>Collecting and Using Your Personal Data</h3><br>
                ...
                <h4>Information from Third-Party Social Media Services</h4><br>
                <div class="text-policy">
                   ...
                   <p>
                    ...
                    is already associated with Your Third-Party Social Media Service's account,
                   ...
                   <p>
                    ...
                    or otherwise, You are giving the Company permission to use, share, and store 
                ...
                <div class="text-policy">
                    ...
                    <ol>
                        <li>Cookies or Browser Cookies. A cookie is a small file placed on Your Device.
                         You can instruct Your browser to refuse all Cookies or to indicate when a 
                         Cookie is being sent. However, if You do not accept Cookies, You may not be 
                         able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.</li>
                        <li>Flash Cookies. Certain features of our Service may use local stored
                            ...
                            eleting local shared objects?" available at 
                            https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_
                        </li>
                        <li>Web Beacons. Certain sections of our Service and our emails may 
                ...
                <div class="text-policy">
                    ...
                    <ol>
                        <li>By email: info@karmabhoomisamaj.com</li>
                        <li>By phone number: +977-1-5250141</li>
                    </ol>
                </div>
            </div>
        </div>
