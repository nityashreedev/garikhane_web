...
<div class="row">
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<h4 class="header-title">partner Table</h4>
				<p class="text-muted font-13 mb-4"></p>
               

                
				<a href="{{url('/admin/partner/create')}}" style="float: right;margin-top: 39px;"
						...
						<tr>
							...
							<td style="width:268.8px">
								<div class="card shadow">
										...
										<a href="{{asset('/images/partner/'.$partner->image)}}"
                                            class="image-popup full-image" title="Screenshot-1">
											<img src="{{asset('/images/partner/'.$partner->image)}}" class="img-fluid"
								...
								<td>{{$partner->link}}</td>
								<td>
									<a href="{{URL::to('admin/partner/'.$partner->id.'/edit')}}" class="btn btn-success">
                                    Edit </a>
									<a class="btn btn-success delete" data-toggle="tooltip" data-placement="bottom"
                                    href="{{URL::to('admin/partner/'.$partner->id.'/delete')}}"> Delete </a>
								</td>
							</tr>
                        @endforeach
                        @endif
