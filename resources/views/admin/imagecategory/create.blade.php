...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Create Image Category</h4>
                <p class="sub-header"></p>
                <div class="row">
                    <div class="col-lg-6">
                      
                        <form action="{{isset($purpose) ? url('admin/imagecategory/store/'.$gallerys->id) :  url('admin/imagecategory/store') }}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div id="thumb-output">
                                @if( isset($purpose) && $gallerys->image)
                                    <img  src="{{asset('/images/gallerycategory/'.$gallerys->image)}} "
